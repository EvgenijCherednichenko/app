    ...
    <div class="container">
        ...
        <main class="row">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <p class="h2 text-center mt-2 mb-2">FAQ</p>
                        <div class="card-body text-center">
                            <p class="d-inline-flex gap-1">
                                <a class="btn btn-primary" data-bs-toggle="collapse" href="#collapseExample_1"
                                   role="button"
                                   aria-expanded="false" aria-controls="collapseExample">
                                    Как купить?
                                </a>
                                <a class="btn btn-primary" data-bs-toggle="collapse" href="#collapseExample_2"
                                   role="button"
                                   aria-expanded="false" aria-controls="collapseExample">
                                    Как доставить?
                                </a>
                                <a class="btn btn-primary" data-bs-toggle="collapse" href="#collapseExample_3"
                                   role="button"
                                   aria-expanded="false" aria-controls="collapseExample">
                                    Какая гарантия?
                                </a>
                            ...
                            <div class="collapse" id="collapseExample_2">
                                <div class="card card-body">
                                    Доставка бесплатная от любой суммы заказа.
                                </div>
                            </div>
